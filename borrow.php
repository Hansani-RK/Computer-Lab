  ...
  <input type="submit" name="submit" value="Submit" class="btn btn-primary">
            ...
            <section>               
                <div class="add-item-container">
                    <div class="row add-item-root">
                            <div class="col-md-offset-1 col-md-10 add-item-root-sub">
                                <div class="add-item-sub-root">
                                        <div class="row">
                                            <p class="item-root-title">Add to repair</p>
                                        </div>
                                        ...
                                        <div class="row add-item">
                                                <div class="col-md-3 add-item-sub-label">
                                                    <p class="text-label">Borrowed date</p>
                                                </div>
                                                <div class="col-md-9">
                                                    <input class="form-control" type="text" name="bod">
                                                </div>
                                        </div>
                                        <div class="row add-item">
                                                <div class="col-md-3 add-item-sub-label">
                                                    <p class="text-label" >Borrowed by</p>
                                                </div>
                                                <div class="col-md-9">
                                        ...
                                        <div class="row add-item">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control" type="text" name="b_tel">
                                                </div>
                                        </div> 
                    ...
                    </div><a href="up.php">Update item deatil</a>
                </div>
            </section>
			</form>
        </div>
