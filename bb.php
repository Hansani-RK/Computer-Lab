...
<!--<p>
  ...
  <input type="submit" name="submit" value="Submit" class="btn btn-primary">
			...
			<form action="borrow21.php" method="GET">
            <section>               
                <div class="add-item-container">
                    <div class="row add-item-root">
                            <div class="col-md-offset-1 col-md-10 add-item-root-sub">
                                <div class="add-item-sub-root">
                                        <div class="row">
                                            <p class="item-root-title"><a href="borrow.php">Borrowed item</a></p>
                                        </div>
										
										<div class="row">
                                            <p class="item-root-title"><a href="borrow2.php">Recieved item</a></p>
                                        </div> 
                                        <div class="row">
                                            
											<input type="submit" name="search" value="Search Repair Item Details" class="btn btn-primary">
                    ...
                    <a href="up.php">Update item deatil</a>
                </div>
            </section>
			</form>
        </div>
