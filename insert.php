                    ...
                    <div class="row add-item-root">
                            <div class="col-md-offset-1 col-md-10 add-item-root-sub">
                                <div class="add-item-sub-root">
                                        ...
                                        <div class="row add-item">
                                                <div class="col-md-3 add-item-sub-label">
                                                    <p class="text-label">Repair date</p>
                                                </div>
                                                <div class="col-md-9">
                                                    <input class="form-control" type="text" name="give">
                                                </div>
                                        </div>
                                        <div class="row add-item">
                                                <div class="col-md-3 add-item-sub-label">
                                        ...
                                        <div class="row add-item">
                                                <div class="col-md-3 add-item-sub-label">
                                                    <p class="text-label">Company Tel</p>
                                                </div>
                                                <div class="col-md-9">
                                                    <input class="form-control" type="text" name="c_tel">
                                                </div>
                                        </div> 
